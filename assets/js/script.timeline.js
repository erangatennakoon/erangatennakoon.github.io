function Timeline(cvs) {
    ...
    function InitDots() {
        ...
        tl.find('article:first figure').each(function () {
            ...
            // Distance to each figure from the middle-lines
    ...
    function redraw() {
        ...
        for (var i = 0; i < 2; i++) {
            ...
            ctx.beginPath();
            ctx.lineWidth = 2; // Thickness of the main vertical lines
            ...
            // Dots
            ctx.lineWidth = 1.2; // Thickness of the line connecting dots (original value)
            ...
            for (var j = 0; j < self.lines[i].dots.length; j++) {
                ...
                ctx.lineWidth = 3; // Adjust this value to increase the thickness of the lines connecting dots
                drawLine(p1, p2);
